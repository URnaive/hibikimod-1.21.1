...
public class ModItems {
    ...
    public static final Item STEVE_FLUID_BUCKET = registerItems("steve_fluid_bucket",
            new BucketItem(ModFluids.STEVE_FLUID, new Item.Settings().recipeRemainder(Items.BUCKET).maxCount(1)));
